...
export function renderControls(container, state, dispatch) {
  ...
  container.querySelector('[data-action="randomize-balls"]').addEventListener('click', () => dispatch({ type: 'randomizeBalls' }));
  ...
  container.querySelector('[data-action="center-tip"]').addEventListener('click', () => dispatch({ type: 'setTip', clockAngle: 0, level: 0 }));
