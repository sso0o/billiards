...
container.innerHTML = `
    ...
    <section data-control="thickness"><h2>두께</h2><output>${Math.round(state.thickness * 8)}/8</output><input type="range" min="0" max="1" step="0.125" value="${state.thickness}"><div><button data-side="-1">왼쪽 맞힘</button><button data-side="1">오른쪽 맞힘</button></div></section>
